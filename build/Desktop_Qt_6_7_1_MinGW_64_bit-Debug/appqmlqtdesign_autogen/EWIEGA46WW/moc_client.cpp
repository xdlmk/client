...
Q_CONSTINIT static const uint qt_meta_data_CLASSClientENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       5,    0,   59,    2, 0x06,    5 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       6,    2,   60,    2, 0x0a,    6 /* Public */,
       8,    0,   65,    2, 0x0a,    9 /* Public */,
       9,    1,   66,    2, 0x0a,   10 /* Public */,
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newInMessage(); break;
        case 1: _t->errorWithConnect(); break;
        ...
        case 6: _t->sendToServer((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Client::newInMessage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Client::*)();
            if (_t _q_method = &Client::errorWithConnect; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (Client::*)();
            if (_t _q_method = &Client::loginFail; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->messageFrom(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setMessageFrom(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void Client::newInMessage()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Client::errorWithConnect()
{
